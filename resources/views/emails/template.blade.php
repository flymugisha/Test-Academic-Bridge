                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 30px 40px 30px 40px; text-align: center;"> <span
                                        style="color:#fff; font-size: 30px">{{ config('app.name_app') }}</span> </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                            ...
                            {{--  <tr>
                                <td align="center"
                                    ...
                                    <p style="font-size: 14px; font-weight: 800; line-height: 18px; color: #333333;">
                                        Duma Taxi<br> 157 Chaussee Prince Louis Rwagasore, Bujumbura </p>
                                </td>
                            </tr>
                            <tr>
                                <td
                                    ...
                                    <p style="margin: 0;">This email was sent to you from admin@duma.africa</p>
                                </td>
                            </tr>  --}}
                            <tr>
                                <td
                                    ...
                                    <p style="margin: 0;">Copyright &copy; 2023 <b>{{ config('app.name_app') }}</b>, All
                                        Rights Reserved.
                                    </p>
                                </td>
                            </tr>
